...
import { X, Send, CheckCircle2, User, Mail, MessageSquare, Type } from 'lucide-react';
        ...
        >
          ...
          <div className="p-8">
            {!isSuccess ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input 
                      ...
                      type="text" 
                      placeholder="Nom" 
                      className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 pl-12 pr-6 text-sm focus:outline-none focus:border-secondary transition-all font-medium"
                    />
                  </div>
                  <div className="relative">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                ...
                <div className="relative">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-4 pl-12 pr-6 text-sm focus:outline-none focus:border-secondary transition-all font-medium resize-none"
                  />
                </div>
                ...
                <Button 
                  ...
                  type="submit" 
                  className="w-full h-16 rounded-2xl bg-secondary text-white font-black text-lg gap-3 hover:scale-[1.02] transition-transform active:scale-95 disabled:grayscale pt-1"
                >
                  {isSubmitting ? (
                     <motion.div 
                        animate={{ rotate: 360 }}
              ...
              >
                <div className="w-24 h-24 bg-blue-100 text-secondary rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <p className="text-slate-500 font-medium">
                  Merci ! Votre message a bien été transmis. Nous reviendrons vers vous très prochainement.
                </p>
                <Button 
                  onClick={onClose}
